...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "../../.." /I "../../../zend" /I "../../../TSRM" /I "../../../main" /D "NDEBUG" /D ZEND_DEBUG=0 /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "HAVE_EACCELERATOR" /D "COMPILE_DL_EACCELERATOR" /D "ZEND_WIN32" /D "PHP_WIN32" /D ZTS=1 /D HAVE_EXT_SESSION_PHP_SESSION_H=1 /D "WITH_EACCELERATOR_CRASH_DETECTION" /D "WITH_EACCELERATOR_OPTIMIZER" /D "WITH_EACCELERATOR_ENCODER" /D "WITH_EACCELERATOR_LOADER" /D "WITH_EACCELERATOR_SESSIONS" /D "WITH_EACCELERATOR_CONTENT_CACHING" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "../../.." /I "../../../zend" /I "../../../TSRM" /I "../../../main" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "HAVE_EACCELERATOR" /D "COMPILE_DL_EACCELERATOR" /D "ZEND_WIN32" /D "PHP_WIN32" /D ZTS=1 /D ZEND_DEBUG=1 /D HAVE_EXT_SESSION_PHP_SESSION_H=1 /D "WITH_EACCELERATOR_CRASH_DETECTION" /D "WITH_EACCELERATOR_OPTIMIZER" /D "WITH_EACCELERATOR_ENCODER" /D "WITH_EACCELERATOR_LOADER" /D "WITH_EACCELERATOR_SESSIONS" /D "WITH_EACCELERATOR_CONTENT_CACHING" /YX /FD /GZ /c
